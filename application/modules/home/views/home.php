  ...
  <div class="parallax-carousel">
    <div class="parallax-block">
      <div class="parallax-box">
        <img src="<?php echo media_url('frontend/images/parallax-bg.jpg') ?>" alt="parallax" width="1920" height="600"/>
      </div>
      <div class="parallax-content">
        ...
        <ul>
          <li><img src="<?php echo media_url('frontend/images/parallax-thumb1.jpg') ?>" alt="parallax-thumb1" width="100" height="80"/></li>
          <li><img src="<?php echo media_url('frontend/images/parallax-thumb2.jpg') ?>" alt="parallax-thumb2" width="100" height="80"/></li>
          <li><img src="<?php echo media_url('frontend/images/parallax-thumb3.jpg') ?>" alt="parallax-thumb3" width="100" height="80"/></li>
        </ul>
      </div>
    </div>      
    <div class="parallax-block">
