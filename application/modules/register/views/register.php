			...
			<form class="contactus-form" action="<?php echo site_url('contact') ?>" method="POST">
				...
				<div class="getintouch">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" required="" placeholder="PIC Pembayaran Tlp" class="form-control" name="register_pay_tlp">
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" required="" placeholder="PIC Pembayaran Fax" class="form-control" name="register_pay_name">
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" required="" placeholder="PIC Pembayaran Handphone" class="form-control" name="register_pay_name">
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
